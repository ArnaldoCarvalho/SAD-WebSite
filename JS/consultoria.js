...
const modelosPorGama = {
  luxo: ['BMW Série 7', 'Mercedes-Benz Classe S', 'Audi A8', 'Lexus LS', 'Jaguar XJ', 'Porsche Panamera'],
  medio: ['Toyota Corolla', 'Honda Civic', 'Ford Focus', 'Volkswagen Golf', 'Hyundai Elantra', 'Nissan Altima'],
  economico: ['Chevrolet Onix', 'Renault Kwid', 'Fiat Mobi', 'Citroën C3', 'Peugeot 208', 'Suzuki Swift']
};
